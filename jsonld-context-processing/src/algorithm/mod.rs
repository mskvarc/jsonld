            ...
            syntax::ContextEntry::Definition(context) => {
                ...
                let import_context = match &context.import {
                    Some(import_value) => {
                        ...
                        // @import.
                        let import = resolve_iri(env.vocabulary, import_value.as_ref(), base_url.as_ref()).ok_or(Error::InvalidImportValue)?;
                        ...
                        match &import_context {
                            syntax::context::Context::One(syntax::ContextEntry::Definition(import_context_def)) => {
